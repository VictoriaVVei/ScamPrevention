...
export function DetectionResult({ onBack, onPlayAgain }) {
  ...
  const sourceSaved =
    resultSavedMessages && resultSavedMessages.length > 0
      ? resultSavedMessages
      : savedMessages;
  const sourceTruth =
    resultCorrectScams && resultCorrectScams.length > 0
      ? resultCorrectScams
      : correctScams;
  ...
  const handlePlayAgain =
    onPlayAgain || (() => navigate("/detection-game/play"));
      ...
      <main className={styles.main}>
        ...
        <section className={styles.card}>
          ...
          <div
            ...
            tabIndex={0}
            onKeyDown={(e) =>
              (e.key === "Enter" || e.key === " ") && toggle("correct")
            }
          >
            <div className={styles.row}>
              <div className={styles.left}>
                ...
                >
                  <path
                    d="M21.7905 9.99539C22.247 12.2357 21.9217 14.5647 20.8688 16.5941C19.8159 18.6236 18.0991 20.2307 16.0047 21.1476C13.9103 22.0644 11.5649 22.2355 9.35954 21.6324C7.15423 21.0293 5.22234 19.6883 3.88604 17.8332C2.54974 15.9781 1.88981 13.7209 2.01629 11.4381C2.14278 9.15531 3.04803 6.98486 4.5811 5.28873C6.11416 3.59259 8.18237 2.47328 10.4408 2.11747C12.6993 1.76166 15.0114 2.19084 16.9917 3.33346"
                    stroke="var(--right)"
                  ...
                  />
                  <path
                    d="M8.99609 10.9949L11.9947 13.9936L21.9901 3.99817"
                    stroke="var(--right)"
                    stroke-width="1.99908"
                    stroke-linecap="round"
                    stroke-linejoin="round"
              ...
              <span className={styles.value}>
                {stats.correctlyIdentified.length}
              </span>
            </div>

            <div
              className={`${styles.detailBox} ${
                isOpen("correct") ? styles.open : styles.closed
              }`}
            >
              {isOpen("correct") && (
                <div className={styles.hint}>
                  Click any item to view its detailed scam explanation.
                </div>
              )}
              {stats.correctlyIdentified.map((it) => (
                <div key={keyOf(it)} className={styles.detailItem}>
                  <span className={styles.appTag}>
                    {appLabel(it.sourceApp)}
                  </span>
                  <span
          ...
          <div
            ...
            tabIndex={0}
            onKeyDown={(e) =>
              (e.key === "Enter" || e.key === " ") && toggle("false")
            }
          >
            <div className={styles.row}>
              <div className={styles.left}>
                ...
                >
                  <path
                    d="M11.9944 21.9898C17.5147 21.9898 21.9898 17.5147 21.9898 11.9944C21.9898 6.47411 17.5147 1.99902 11.9944 1.99902C6.47411 1.99902 1.99902 6.47411 1.99902 11.9944C1.99902 17.5147 6.47411 21.9898 11.9944 21.9898Z"
                    stroke="var(--wrong)"
                    stroke-width="1.99908"
                    stroke-linecap="round"
                    stroke-linejoin="round"
                  />
                  <path
                    d="M14.9933 8.99585L8.99609 14.9931"
                    stroke="var(--wrong)"
                    stroke-width="1.99908"
                    stroke-linecap="round"
                    stroke-linejoin="round"
                  />
                  <path
                    d="M8.99609 8.99585L14.9933 14.9931"
                    stroke="var(--wrong)"
                    stroke-width="1.99908"
                    stroke-linecap="round"
                    stroke-linejoin="round"
            ...
            <div
              className={`${styles.detailBox} ${
                isOpen("false") ? styles.open : styles.closed
              }`}
            >
              {isOpen("false") && (
                <div className={styles.hint}>
          ...
          <div
            ...
            tabIndex={0}
            onKeyDown={(e) =>
              (e.key === "Enter" || e.key === " ") && toggle("missed")
            }
          >
            <div className={styles.row}>
              <div className={styles.left}>
            ...
            <div
              className={`${styles.detailBox} ${
                isOpen("missed") ? styles.open : styles.closed
              }`}
            >
              {isOpen("missed") && (
                <div className={styles.hint}>
        ...
        <div className={styles.btnWrap}>
          <button className="mainStartBtn" onClick={handlePlayAgain}>
            ...
            >
              ...
              />
              <path
                d="M2.99854 2.99866V7.99635H7.99623"
                stroke="white"
                stroke-width="1.99908"
                stroke-linecap="round"
                stroke-linejoin="round"
