...
export function LandingPage() {
    ...
    const handleScroll = () => {
      if (!ticking) {
        requestAnimationFrame(() => {
          ...
          if (
            JSON.stringify(newVisibleSections) !==
  ...
  const flipCard_open = throttle(() => {
    if (demoVideoTitle_containerRef.current && demoVideoContainerRef.current) {
      ...
      demoVideoContainerRef.current.style.transform =
        "translateX(0px) rotateY(-180deg)";
      demoVideoTitleRef.current.style.transform = "translateX(200px)";
      setTimeout(() => {
        demoVideoTitle_containerRef.current.style.transform =
          "translateX(0px) rotateY(180deg)";
        demoVideoContainerRef.current.style.transform =
  ...
  const flipCard_close = throttle(() => {
    if (demoVideoTitle_containerRef.current && demoVideoContainerRef.current) {
      ...
      demoVideoContainerRef.current.style.transform =
        "translateX(200px) rotateY(-180deg)";
  ...
  return (
    <div id={styles.landing}>
      ...
      <div
        className={`${styles.logo} ${isScrolled ? styles.logo_scrolled : ""}`}
        onClick={topFunction}
      >
      ...
      <div
        className={`${styles.welcome_board} ${
          isScrolled ? styles.welcome_board_scrolled : ""
        }`}
      >
        <div
          className={`${styles.welcome_content} ${
            isScrolled ? styles.welcome_content_scrolled : ""
          }`}
        >
          <div className={styles.word}>
            ...
            <p>
              A shared space for learning and mutual protection. We believe the
              best way to fight scams is by sharing verified stories, real
              experiences, and clear guidelines — so no one has to face
              deception alone.
            </p>
          </div>
          <div className={styles.buttonContainer}>
            <NavLink to="" onClick={topFunction} className={styles.button}>
              Explore
            </NavLink>
            <div onClick={() => setIsOpen(true)} className={styles.button}>
              Follow
            </div>
          </div>
        </div>
        <div className={styles.videoContainer}>
          <div
            className={styles.demoVideo_title}
            ref={demoVideoTitle_containerRef}
            onMouseEnter={flipCard_open}
          >
            <h1
              style={{ fontFamily: "Momo Signature", transition: "1s" }}
              ref={demoVideoTitleRef}
            >
              Demo Video
            </h1>
          </div>
          <div
            className={styles.demoVideo_container}
            ref={demoVideoContainerRef}
            onMouseLeave={flipCard_close}
          >
            <iframe
              width="100%"
              height="100%"
              style={{ borderRadius: "10px" }}
              src="https://www.youtube.com/embed/DguRIuX6lvQ"
              frameBorder="0"
      ...
      <main>
        <div>
          <svg
            ...
            className={`${styles.icon} ${
              visibleSections.icon1 ? styles.visible : ""
            }`}
            style={{ opacity: "1" }}
            viewBox="0 0 1024 1024"
            version="1.1"
          ...
          >
            <path
              d="M762 512L512 912 262 512l250-400z"
              p-id="1667"
              fill="white"
            ></path>
          </svg>
        ...
        <div
          className={`${styles.intro1} ${
            visibleSections.intro1 ? styles.visible : ""
          }`}
        >
          <div className={styles.intro1_1}>
            <div>
              ...
              <p>
                Online scams are everywhere — from fake scholarship offers to
                online marketplace traps. Many people, are unsure how to tell
                what's real and what's not. ScamHub Community exists to make
                scam awareness accessible, simple, and human.
              </p>
            </div>
          </div>
          <div
            className={styles.intro1_1}
            style={{ gridRow: "2", gridColumn: "2" }}
          >
            <div>
              <h1>Who are the target users?</h1>
              <p>
                <strong>Students</strong> and <strong>Elders</strong> are the
                primary users of ScamHub Community. But anyone who wants to stay
                safe online can benefit from our platform.
              </p>
            </div>
          </div>
          <div
        ...
        <div>
          <svg
            t="1761800988529"
            className={`${styles.icon} ${
              visibleSections.icon2 ? styles.visible : ""
            }`}
            viewBox="0 0 1024 1024"
            version="1.1"
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div
          className={`${styles.intro2} ${
            visibleSections.intro2 ? styles.visible : ""
          }`}
        ...
        >
          ...
          <div className={styles.intro2_1}>
            ...
            <div>
              ...
              >
                <path
                  d="M231.78666667 507.73333333v154.45333334l280.32 146.24 280.53333333-146.24V507.73333333L512.32 653.97333333 231.78666667 507.73333333z m280.53333333-392.64L70.93333333 345.92l441.38666667 230.72 360.96-188.58666667v265.92h80.42666667V345.92L512.32 115.09333333z"
                  p-id="8616"
                  fill="var(--white)"
                ></path>
              </svg>
        ...
        <div>
          <svg
            t="1761800988529"
            className={`${styles.icon} ${
              visibleSections.icon3 ? styles.visible : ""
            }`}
            viewBox="0 0 1024 1024"
            version="1.1"
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div
          className={`${styles.intro3} ${
            visibleSections.intro3 ? styles.visible : ""
          }`}
          style={{ textAlign: "center" }}
        >
          <h1>Team Member</h1>
      ...
      <div
        className={styles.input_area_fullScreen}
        ref={input_area_fullScreenRef}
      >
        <div
          className={styles.input_area_background}
