...
export function Phone({
  ...
  const BankSvg = (props) => (
    ...
    >
      ...
      />
      <path
        d="M18.6665 27.9997V23.9998C18.6665 23.2925 18.3856 22.6143 17.8855 22.1142C17.3854 21.6141 16.7071 21.3331 15.9999 21.3331C15.2927 21.3331 14.6144 21.6141 14.1143 22.1142C13.6142 22.6143 13.3333 23.2925 13.3333 23.9998V27.9997"
        stroke="white"
        stroke-width="2.66664"
        stroke-linecap="round"
        stroke-linejoin="round"
      ...
      />
      <path
        d="M8 27.9997V6.66658C8 5.95934 8.28095 5.28107 8.78104 4.78098C9.28113 4.28089 9.9594 3.99994 10.6666 3.99994H21.3332C22.0404 3.99994 22.7187 4.28089 23.2188 4.78098C23.7189 5.28107 23.9998 5.95934 23.9998 6.66658V27.9997"
        stroke="white"
        stroke-width="2.66664"
        stroke-linecap="round"
        stroke-linejoin="round"
  ...
  const PhotosSvg = (props) => (
    ...
    >
      <path
        d="M25.3331 3.99994H6.66664C5.1939 3.99994 4 5.19383 4 6.66658V25.3331C4 26.8058 5.1939 27.9997 6.66664 27.9997H25.3331C26.8059 27.9997 27.9998 26.8058 27.9998 25.3331V6.66658C27.9998 5.19383 26.8059 3.99994 25.3331 3.99994Z"
        stroke="white"
        stroke-width="2.66664"
        stroke-linecap="round"
        stroke-linejoin="round"
      />
      <path
        d="M11.9999 14.6665C13.4726 14.6665 14.6665 13.4726 14.6665 11.9999C14.6665 10.5271 13.4726 9.33325 11.9999 9.33325C10.5271 9.33325 9.33325 10.5271 9.33325 11.9999C9.33325 13.4726 10.5271 14.6665 11.9999 14.6665Z"
        stroke="white"
        stroke-width="2.66664"
        stroke-linecap="round"
        stroke-linejoin="round"
      />
      <path
        d="M27.9998 19.9998L23.8852 15.8852C23.3851 15.3853 22.707 15.1044 21.9999 15.1044C21.2928 15.1044 20.6146 15.3853 20.1145 15.8852L8 27.9997"
        stroke="white"
        stroke-width="2.66664"
        stroke-linecap="round"
        stroke-linejoin="round"
  ...
  const MusicSvg = (props) => (
    ...
    >
      <path
        d="M11.9998 23.9997V6.66658L27.9996 3.99994V21.3331"
        stroke="white"
        stroke-width="2.66664"
        stroke-linecap="round"
        stroke-linejoin="round"
      />
      <path
        d="M7.99996 27.9997C10.2091 27.9997 11.9999 26.2088 11.9999 23.9997C11.9999 21.7906 10.2091 19.9998 7.99996 19.9998C5.79084 19.9998 4 21.7906 4 23.9997C4 26.2088 5.79084 27.9997 7.99996 27.9997Z"
        stroke="white"
        stroke-width="2.66664"
        stroke-linecap="round"
        stroke-linejoin="round"
      />
      <path
        d="M23.9997 25.333C26.2088 25.333 27.9997 23.5422 27.9997 21.3331C27.9997 19.124 26.2088 17.3331 23.9997 17.3331C21.7906 17.3331 19.9998 19.124 19.9998 21.3331C19.9998 23.5422 21.7906 25.333 23.9997 25.333Z"
        stroke="white"
        stroke-width="2.66664"
        stroke-linecap="round"
        stroke-linejoin="round"
  ...
  const endAtRef = useRef(
    Date.now() + (Number.isFinite(totalSeconds) ? totalSeconds : 300) * 1000
  );
  ...
  const limitedSelected = useMemo(() => {
    ...
    const considerForMinimum = new Set([
      APPS.MAIL,
      APPS.WECHAT,
      APPS.TINDER,
      APPS.PHOTOS,
    ...
    while (
      scamCount < MIN_SCAMS_TOTAL &&
      replaceSlots.length > 0 &&
      scamCandidates.length > 0
    ) {
  ...
  const handleRequestRemove = (e) => {
    ...
    const found = (savedMessages || []).find(
  ...
  const renderHeader = () => {
          ...
          <div className={styles.timerHeader_wrapper}>
            <div className={styles.timerIcon}>
              ...
              >
                ...
                />
                <path
                  d="M15.9998 18.6665L19.9997 14.6665"
                  stroke="white"
                  stroke-width="2.66664"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                />
                <path
                  d="M15.9998 29.3331C21.8908 29.3331 26.6664 24.5575 26.6664 18.6665C26.6664 12.7755 21.8908 7.99994 15.9998 7.99994C10.1088 7.99994 5.33325 12.7755 5.33325 18.6665C5.33325 24.5575 10.1088 29.3331 15.9998 29.3331Z"
                  stroke="white"
                  stroke-width="2.66664"
                  stroke-linecap="round"
                  stroke-linejoin="round"
    ...
    return (
      <div
        ...
        style={{ backgroundColor: headerBgMap[activeApp] }}
      >
        <button
    ...
    <>
      ...
      <div className={styles.dock}>
        ...
        >
          ...
          >
            <path
              d="M27.9997 27.9996L22.2131 22.213"
              stroke="white"
              stroke-width="2.66664"
              stroke-linecap="round"
              stroke-linejoin="round"
            />
            <path
              d="M14.6666 25.3331C20.5575 25.3331 25.3331 20.5575 25.3331 14.6666C25.3331 8.77558 20.5575 4 14.6666 4C8.77558 4 4 8.77558 4 14.6666C4 20.5575 8.77558 25.3331 14.6666 25.3331Z"
              stroke="white"
              stroke-width="2.66664"
              stroke-linecap="round"
              stroke-linejoin="round"
  ...
  const renderAppContent = () => {
    ...
    switch (activeApp) {
      ...
      case APPS.SCAMS_FOUND:
        return (
          <div style={{ height: "100%", backgroundColor: "var(--white)" }}>
            <div
              className={`${styles.appHeader} ${styles.appHeaderColored}`}
            ...
            >
              <button
                className={"backButton"}
                onClick={goHome}
                style={{ position: "absolute", color: "var(--white)" }}
              >
                &lt; Back
              </button>
                    ...
                    >
                      ...
                      <div className={styles.msgContent}>
                        <div className={styles.msgTitle}>
                          {m.title || m.text || "Untitled"}
                        </div>
                        {m.shortSummary && (
                          <div className={styles.msgText}>{m.shortSummary}</div>
                        )}
                      </div>
                    </div>
      ...
      case APPS.MUSIC:
        return (
          <div
            style={{
              background: "linear-gradient(180deg, #18a193, #007669)",
              height: "100%",
            }}
          >
            {renderHeader()}
            <div className={styles.musicScreen}>
              ...
              <div className={styles.musicControls}>
                <button
                  className={styles.musicControlBtn}
              ...
              >
                <g filter="url(#filter0_d_278_1279)">
                  <g clip-path="url(#clip0_278_1279)">
                    <path
                      d="M38 37C38 23.7452 48.7452 13 62 13H359.022C372.277 13 383.022 23.7452 383.022 37V196.987C383.022 210.242 372.277 220.987 359.022 220.987H62C48.7451 220.987 38 210.242 38 196.987V37Z"
                      fill="url(#paint0_linear_278_1279)"
                    />
                    <g opacity="0.1">
                      <path
                        d="M222.65 12.9955C222.65 -57.6945 279.955 -115 350.645 -115C421.335 -115 478.641 -57.6945 478.641 12.9955C478.641 83.6855 421.335 140.991 350.645 140.991C279.955 140.991 222.65 83.6855 222.65 12.9955Z"
                        fill="white"
                      />
                      <path
                        d="M-58 220.992C-58 167.975 -15.0216 124.997 37.995 124.997C91.0116 124.997 133.99 167.975 133.99 220.992C133.99 274.009 91.0116 316.987 37.995 316.987C-15.0216 316.987 -58 274.009 -58 220.992Z"
                        fill="white"
                      />
                    </g>
                    <path
                      d="M61.9888 56.9885C61.9888 45.943 70.9429 36.989 81.9883 36.989C93.0337 36.989 101.988 45.943 101.988 56.9885C101.988 68.0339 93.0337 76.988 81.9883 76.988C70.9429 76.988 61.9888 68.0339 61.9888 56.9885Z"
                      fill="white"
                    />
                    <path
                      d="M81.9883 46.9931V66.9839"
                      stroke="#155DFC"
                      stroke-width="1.99908"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    />
                    <path
                      d="M86.9857 49.9917H79.4891C78.5613 49.9917 77.6715 50.3603 77.0154 51.0164C76.3593 51.6724 75.9907 52.5623 75.9907 53.4901C75.9907 54.4179 76.3593 55.3077 77.0154 55.9638C77.6715 56.6199 78.5613 56.9885 79.4891 56.9885H84.4868C85.4146 56.9885 86.3045 57.3571 86.9605 58.0131C87.6166 58.6692 87.9852 59.559 87.9852 60.4869C87.9852 61.4147 87.6166 62.3045 86.9605 62.9606C86.3045 63.6167 85.4146 63.9852 84.4868 63.9852H75.9907"
                      stroke="#155DFC"
                      stroke-width="1.99908"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                ...
                <defs>
                  ...
                  >
                    ...
                    <feMorphology
                      ...
                      operator="erode"
                      in="SourceAlpha"
                      result="effect1_dropShadow_278_1279"
                    />
                    <feOffset dy="25" />
                    ...
                    <feBlend
                      mode="normal"
                      in="SourceGraphic"
                      in2="effect1_dropShadow_278_1279"
                      result="shape"
                    />
                  </filter>
                  <linearGradient
                    id="paint0_linear_278_1279"
                    x1="38"
                    y1="13"
                    x2="221.922"
                    y2="318.102"
              ...
              <div className={styles.bankInfoBox}>
                ...
                >
                  <g filter="url(#filter0_dd_278_1308)">
                    <path
                      d="M12 26C12 12.7452 22.7452 2 36 2H333.022C346.277 2 357.022 12.7452 357.022 26V294.722C357.022 307.977 346.277 318.722 333.022 318.722H36C22.7451 318.722 12 307.977 12 294.722V26Z"
                      fill="white"
                  ...
                  <defs>
                    ...
                    >
                      ...
                      <feMorphology
                        ...
                        operator="erode"
                        in="SourceAlpha"
                        result="effect1_dropShadow_278_1308"
                      />
                      <feOffset dy="4" />
                      ...
                      <feMorphology
                        ...
                        operator="erode"
                        in="SourceAlpha"
                        result="effect2_dropShadow_278_1308"
                      />
                      <feOffset dy="10" />
                      ...
                      <feBlend
                        mode="normal"
                        in2="effect1_dropShadow_278_1308"
                        result="effect2_dropShadow_278_1308"
                      />
                      <feBlend
                        mode="normal"
                        in="SourceGraphic"
                        in2="effect2_dropShadow_278_1308"
                        result="shape"
                      />
                    </filter>
                  </defs>
...
/* ---------- Home Icon Component---------- */
export function HomeIcon({ label, badge, icon, type, onClick }) {
  return (
    <button className={`${styles.homeIcon} ${styles[type]}`} onClick={onClick}>
      {badge !== undefined && <span className={styles.homeBadge}>{badge}</span>}
...
export function MessageRow({ message, onLongPress }) {
